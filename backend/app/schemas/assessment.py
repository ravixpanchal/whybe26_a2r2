...
class BorrowerInput(BaseModel):
    ...
    upi_months_active: int | None = Field(default=None, ge=0)
    ...
    rent_paid_on_time_months: int | None = Field(default=None, ge=0)
    total_rental_months: int | None = Field(default=None, ge=0)
